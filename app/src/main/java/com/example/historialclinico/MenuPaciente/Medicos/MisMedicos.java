...
public class MisMedicos extends Fragment implements androidx.appcompat.widget.SearchView.OnQueryTextListener, Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mis_medicos, container, false);
    ...
    private void cargarWebService() {
        ...
        String URL="https://192.168.1.77/login/misMedicos.php?idPaciente="+idPaciente;
