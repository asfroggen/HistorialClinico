...
public class EditarBiometria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_biometria);
        ...
        tvGlucosaAnterior.setText(leucocitos);
        tvColesterolAnterior.setText(eritrocitos);
        tvHierroAnterior.setText(plaquetas);
        ...
        bActualizarNombre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validarNombre().equals("OK")) {
                    cargando = new SweetAlertDialog(EditarBiometria.this, SweetAlertDialog.PROGRESS_TYPE);
                    cargando.setCancelable(false);
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#FE8629"));
                    cargando.show();
                    Log.d("idAnalisis:", idAnalisis);
                    actualizarAnalisis("biometria", "nombre");
                }
            }
        });
            ...
            public void onClick(View view) {
                if (validarFecha()) {
                    if (validarFechaAnos().equals("OK")) {
                        ...
                        cargando.getProgressHelper().setBarColor(Color.parseColor("#FE8629"));
                        cargando.show();
                        actualizarAnalisis("biometria", "fecha");
                    }
                }
            }
        });
        ...
        bActualizarDatos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validarDatos().equals("OK")) {
                    ...
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#FE8629"));
                    cargando.show();
                    actualizarAnalisis("biometria", "datos");
                }
            }
        });
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://192.168.1.77/login/actualizarAnalisis.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (parametro.equals("nombre")) {
                    new SweetAlertDialog(EditarBiometria.this, SweetAlertDialog.SUCCESS_TYPE)
