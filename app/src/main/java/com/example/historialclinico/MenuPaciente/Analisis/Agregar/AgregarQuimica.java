...
public class AgregarQuimica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_quimica);
                ...
                if(validarDatos().equals("OK")){
                    if (validarFecha()){
                        if(validarFechaAnos().equals("OK")){
                            cargando = new SweetAlertDialog(AgregarQuimica.this, SweetAlertDialog.PROGRESS_TYPE);
    ...
    private void insertarAnalisis(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://192.168.1.77/login/insertarAnalisis.php",new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                new SweetAlertDialog(AgregarQuimica.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.d("datos", fechaNacimiento);
                Log.d("datos1", etGlucosa.getText().toString());
                Log.d("datos2", etColesterol.getText().toString());
                Log.d("datos3", etHierro.getText().toString());
                Log.d("datos4", usuario.getIdPaciente());
                Log.d("datos5", etNombreAnalisis.getText().toString());
                return parametros;
            }
        };
