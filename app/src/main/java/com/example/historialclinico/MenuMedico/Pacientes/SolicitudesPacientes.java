...
import com.example.historialclinico.MenuMedico.Pacientes.Analisis.AdaptadorSolicitudes;
...
public class SolicitudesPacientes extends Fragment implements androidx.appcompat.widget.SearchView.OnQueryTextListener, Response.Listener<JSONObject>,Response.ErrorListener{

    public SolicitudesPacientes() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_solicitudes_pacientes, container, false);
    ...
    private void cargarWebService() {
        ...
        String URL="https://192.168.1.77/login/solicitudesPacientes.php?idMedico="+idMedico;
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            adaptador=new AdaptadorSolicitudes(listaMedicos);
            adaptador.setOnItemClickListener(new AdaptadorSolicitudes.OnItemClickListener() {
                @Override
                public void OnItemClick(int position) {
                    new SweetAlertDialog(getContext(), SweetAlertDialog.WARNING_TYPE)
                            .setTitleText(listaMedicos.get(position).getNombrePacientes()+" quiere agregarte como contacto")
                            .setContentText("¿Aceptar solicitud?")
                            .setConfirmText("Si")
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    cargando.show();
                                    aceptarSoliciud(listaMedicos.get(position).getIdPacientes());
                                }
                            })
    ...
    private void aceptarSoliciud(String idPaciente){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://192.168.1.77/login/aceptarSolicitud.php",new Response.Listener<String>(){
            @Override
            public void onResponse(String response) {
                ...
                new SweetAlertDialog(getContext())
                        .setTitleText("Contacto agregado!")
                        .show();
            }
