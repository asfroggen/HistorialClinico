...
public class ActualizarCredencialesMedico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualizar_credenciales_medico);
        ...
        bActualizarCorreo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(validarDatosCorreo().equals("OK")){
                    cargando = new SweetAlertDialog(ActualizarCredencialesMedico.this, SweetAlertDialog.PROGRESS_TYPE);
                    cargando.setCancelable(false);
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#47BDB5"));
                    cargando.show();
                    actualizarCorreo("medico");
                }
            }
        });
    ...
    private void actualizarPassword(String tipo){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://192.168.1.77/login/actualizarPassword.php",new Response.Listener<String>(){
            ...
            public void onResponse(String response) {
                if (!response.isEmpty()) {
                    ...
                    new SweetAlertDialog(ActualizarCredencialesMedico.this, SweetAlertDialog.SUCCESS_TYPE)
                    ...
                    cargando.dismissWithAnimation();
                    new SweetAlertDialog(ActualizarCredencialesMedico.this, SweetAlertDialog.ERROR_TYPE)
                            .setTitleText("Error")
        ...
        }, error -> Toast.makeText(ActualizarCredencialesMedico.this, error.toString(),Toast.LENGTH_SHORT).show()){
            @Override
