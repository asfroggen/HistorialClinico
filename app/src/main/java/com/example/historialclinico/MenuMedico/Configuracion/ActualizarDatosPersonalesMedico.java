...
public class ActualizarDatosPersonalesMedico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualizar_datos_personales_medico);
        ...
        bActualizarNombre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!etActualizarNombre.getText().toString().isEmpty()){
                    cargando = new SweetAlertDialog(ActualizarDatosPersonalesMedico.this, SweetAlertDialog.PROGRESS_TYPE);
                    cargando.setCancelable(false);
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#47BDB5"));
                    cargando.show();
                    actualizarDatosMedico("nombre");
                }else{
        ...
        bActualizarSegNombre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!etActualizarSegNombre.getText().toString().isEmpty()){
                    ...
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#47BDB5"));
                    cargando.show();
                    actualizarDatosMedico("segNombre");
                }else{
                    Toast.makeText(getApplicationContext(),"Ingrese su nombre",Toast.LENGTH_SHORT).show();
                }
            }
        ...
        bActualizarApellidoP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!etActualizarApellidoP.getText().toString().isEmpty()){
                    ...
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#47BDB5"));
                    cargando.show();
                    actualizarDatosMedico("apellidoPat");
                }else{
        ...
        bActualizarApellidoM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!etActualizarApellidoM.getText().toString().isEmpty()){
                    ...
                    cargando.getProgressHelper().setBarColor(Color.parseColor("#47BDB5"));
                    cargando.show();
                    actualizarDatosMedico("apellidoMat");
                }else{
            ...
            public void onClick(View view) {
                ...
                if (validarFecha(fechaValidar)){
                    if(validarEdad()){
                        ...
                        cargando.show();
                        actualizarDatosMedico("fechaNacimiento");
                    }else{
    ...
    private void actualizarDatosMedico(String tipo){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://192.168.1.77/login/actualizarDatosMedico.php",new Response.Listener<String>(){
            @Override
                ...
                if(!response.isEmpty()){
                    switch (tipo) {
                        case "nombre":
                            ...
                            new SweetAlertDialog(ActualizarDatosPersonalesMedico.this, SweetAlertDialog.SUCCESS_TYPE)
                    ...
                    cargando.dismissWithAnimation();
                    new SweetAlertDialog(ActualizarDatosPersonalesMedico.this, SweetAlertDialog.ERROR_TYPE)
                            .setTitleText("Error")
        ...
        }, error -> Toast.makeText(ActualizarDatosPersonalesMedico.this, error.toString(),Toast.LENGTH_SHORT).show()){
            @Override
