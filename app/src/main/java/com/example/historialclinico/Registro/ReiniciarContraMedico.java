...
public class ReiniciarContraMedico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reiniciar_contra_medico);
        ...
        bActualizarPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validarDatos().equals("OK")){
                    cargando = new SweetAlertDialog(ReiniciarContraMedico.this, SweetAlertDialog.PROGRESS_TYPE);
    ...
    private void actualizarPassword(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://192.168.1.77/login/reiniciarPassword.php",new Response.Listener<String>(){
            ...
            public void onResponse(String response) {
                ...
                new SweetAlertDialog(ReiniciarContraMedico.this, SweetAlertDialog.SUCCESS_TYPE)
        ...
        }, error -> Toast.makeText(ReiniciarContraMedico.this, error.toString(),Toast.LENGTH_SHORT).show()){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                String usuario="medico";
